$(function() {
    var $page = $('#icenter_orderRecord'),
        pageStr = 'icenter_orderRecord';
    ...
    //        content: '<div id="icenter_orderRecord_qrcode" style="padding: 10px 0 0 10px;"></div>'
    //    });
    //}
    //// 根据url创建二维码
    ...
    //    url = $.trim(url);
    //    if (url) {
    //        new QRCode($('#icenter_orderRecord_qrcode')[0], {
    //            width : 190,
    //            height : 190
    //        }).makeCode(url);
    //    }
