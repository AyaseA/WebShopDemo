    ...
    $$.post("CSL/ValueVoucher/QueryValueVoucherJson", {},
        function(txt) {
            if (txt.Status == 0) {
                ...
                if (useList.length == 0) {
                    node = "<div class='noData'><img src='images/discount/nodata.png'><p>暂无优惠券记录</p><div>";
                }

                if (haveList.length == 0) {
                    useNode = "<div class='noData'><img src='images/discount/nodata.png'><p>暂无优惠券记录</p><div>";
                }

                if (dateList.length == 0) {
                    dateNode = "<div class='noData'><img src='images/discount/nodata.png'><p>暂无优惠券记录</p><div>";
                }
