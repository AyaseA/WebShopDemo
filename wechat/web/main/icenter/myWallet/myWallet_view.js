        ...
        success: function(txt) {
            ...
            if(txt.Status != 0){
            	...
            	for(var i=0; i<list.length;i++){
            		...
            		onePiece="<div class='footprint_contain' data-tid='"+list[i].ProductType+"' name='"+i+"'><ul><li><img src='"+url+"Img/"+$$.smallImg(list[i].Img)+"' alt='' class='foot_li_x5_img'></li><li><div class='footprint_text'><span>"+list[i].Name+"</span><br /><span>"+content+"</span></div><div class='footprint_price'><span class='footprint_price_1'>￥<span>"+list[i].Price+"</span></span></div></li></ul></div>";
