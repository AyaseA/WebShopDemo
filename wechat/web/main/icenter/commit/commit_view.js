$(function () {
    ...
    //星星点击事件
    var flag = true;
    $page.on('click', 'div .commit_des .star', function () {
        flag = !flag;
        if (flag) {
            $(this).attr('src', './images/orderCommit/starWhite.png');
        } else {
            $(this).attr('src', './images/orderCommit/star.png');
        }
    });
