    ...
    $$.setGoBack($page.find('>div.header >a.goBack'));
        $('.main>.fight>.btn').click(function() {
            ...
            layer.open({
                ...
                content: "<p style='text-align:center;font-size:3.3vw;color:#8e8c8c;margin-bottom: 2vw;'>请向商家出示二维码，扫一扫，即可验证</p><p style='margin-top:2vw'><img style='width:70vw;' src='fightReq/guanzhu.jpg' alt=''><img src='code/logo.png' style='width:25vw;'></p>",
                area: ["80vw", "115vw"],
                btn: [],
                cancel: function () {
                    clearInterval(time);
